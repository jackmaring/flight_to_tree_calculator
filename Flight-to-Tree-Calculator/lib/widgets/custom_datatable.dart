...
class CustomDataTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // );
    final BoxDecoration _firstRowDecoration = BoxDecoration(
      // border: Border(bottom: Divider.createBorderSide(context, width: 1.0)),
    ...
    final BoxDecoration _lastRowDecoration = BoxDecoration(
      border: Border(
        left: BorderSide(color: CustomColors.mediumGray, width: 2),
        right: BorderSide(color: CustomColors.mediumGray, width: 2),
        bottom: BorderSide(color: CustomColors.mediumGray, width: 2),
    ...
    final BoxDecoration _middleRowDecoration = BoxDecoration(
      border: Border(
        left: BorderSide(color: CustomColors.mediumGray, width: 2),
        right: BorderSide(color: CustomColors.mediumGray, width: 2),
        bottom: BorderSide(color: CustomColors.mediumGray, width: 1),
      ),
    );
