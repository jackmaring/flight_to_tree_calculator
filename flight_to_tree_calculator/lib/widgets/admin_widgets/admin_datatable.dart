            ...
            .map(
              (adminEntry) => CustomDataRow(
                cells: [
                  ...
                  CustomDataCell(
                    Text(
                      '${Calculations.calculateTrees(Calculations.calculateMetricTonsCO2(Calculations.calculateDistance(adminEntry.departure, adminEntry.arrival), Calculations.stringToFlightClass(adminEntry.flightClass)))}',
                    ),
                  ),
